...
import { Camera, Upload, GitBranch, RefreshCw, Sparkles, Layers } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              ...
              <span style={{ fontSize: "0.74rem", color: "#10b981", fontWeight: 600 }}>
                SE4050 Household Waste Classification
              </span>
            </div>
          </div>

          <a
            href="https://github.com/Kamindumenula/SE4050-Household-Waste-Classification-System"
            target="_blank"
            rel="noreferrer"
      ...
      {/* Main Content */}
      <main style={{ maxWidth: "1280px", margin: "0 auto", padding: "24px 20px", flex: 1, width: "100%" }}>
        {/* Model Selector Bar */}
        <ModelSelector
          ...
          <div className="glass-panel" style={{ padding: "18px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                {activeTab === "camera" ? <Camera size={18} color="#10b981" /> : <Upload size={18} color="#06b6d4" />}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
            {compareMode ? (
              ...
              >
                ...
                <p style={{ color: "#94a3b8", fontSize: "0.85rem", maxWidth: "330px", lineHeight: 1.4 }}>
                  Scan a waste item with your camera or select a sample preset to detect if it is cardboard, glass, metal, paper, plastic, or trash.
                </p>
              </div>
            )}
          </div>
      ...
      >
        <div style={{ maxWidth: "1280px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "8px" }}>
          <div>SE4050 Deep Learning Project • Household Waste Classification</div>
          <div style={{ display: "flex", gap: "14px" }}>
            <span>Member 1: Custom CNN</span>
            <span>Member 2: MobileNetV2</span>
            <span>Member 3: ResNet50</span>
            <span>Member 4: EfficientNetB0</span>
          </div>
        </div>
      </footer>
    </div>
